...
import { colorMethod, groupByPermission } from "@/utils";
        ...
        if (temp?.module) {
            ...
            if (restPermission && restPermission.length) {
                const allTrue = restPermission.every((item) =>
                    form.getFieldValue(["permissions", item.id as number])
                );
                ...
                <div className="customize-form-item">
                    <ProFormSwitch
                        ...
                        fieldProps={{
                            ...
                            onChange: (value) =>
                                handleSwitchAll(value, item.module),
                        }}
                    />
                </div>
            ),
