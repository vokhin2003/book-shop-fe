    ...
    <div className="upsert-order-container" style={{ padding: "24px" }}>
      <div className="title" style={{ marginBottom: "24px" }}>
        <Breadcrumb
          ...
          items={[
            {
              title: <Link to="/admin/order">Quản lý đơn hàng</Link>,
            },
            {
              title: isUpdate ? "Cập nhật đơn hàng" : "Tạo đơn hàng mới",
            },
          ]}
        />
      </div>
      ...
      <ConfigProvider locale={enUS}>
        ...
        >
          <Row gutter={[24, 24]}>
            ...
            {/* Order Summary */}
            <Col span={24} lg={12}>
              <Card title="Tổng kết đơn hàng" style={{ height: "100%" }}>
                <Space direction="vertical" style={{ width: "100%" }}>
                  ...
                  >
                    ...
                    <Text>{Number(subtotal).toLocaleString("vi-VN")} đ</Text>
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <Text>{Number(delivery).toLocaleString("vi-VN")} đ</Text>
                  </div>
                  {/* <div
                                        style={{
                                            display: "flex",
            ...
            >
              {books.map((book) => (
                <Option key={book.value} value={book.value}>
                  {book.label} - {Number(book.price).toLocaleString("vi-VN")}
                  {`  (-${book.discount}%)`}
                </Option>
              ))}
            </Select>
