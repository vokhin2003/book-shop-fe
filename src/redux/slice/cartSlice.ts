...
export const fetchCart = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      else return rejectWithValue(response.message || "Không thể lấy giỏ hàng");
    } catch (error) {
      ...
      return rejectWithValue(
        error.message || "Đã có lỗi xảy ra khi lấy giỏ hàng"
      );
    }
  }
);
...
export const addToCart = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      return rejectWithValue(
        res.message || "Không thể thêm sản phẩm vào giỏ hàng"
      );
    } catch (error) {
...
export const updateCart = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      return rejectWithValue(
        res.message || "Không thể cập nhật sản phẩm trong giỏ hàng"
      );
    } catch (error) {
      return rejectWithValue(error.message || "Lỗi không xác định");
    }
...
export const removeFromCart = createAsyncThunk(
  ...
  async (bookId: number, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        res.message || "Không thể xóa sản phẩm khỏi giỏ hàng"
      );
    } catch (error) {
      return rejectWithValue(error.message || "Lỗi không xác định");
    }
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchCart.rejected, (state, action) => {
        ...
        state.error =
          (action.payload as string) || "Đã có lỗi xảy ra khi lấy giỏ hàng";
      })
    ...
    builder
      ...
      .addCase(updateCart.rejected, (state, action) => {
        ...
        state.error =
          (action.payload as string) ||
          "Đã có lỗi xảy ra khi cập nhật sản phẩm trong giỏ hàng";
      })
    ...
    builder
      ...
      .addCase(removeFromCart.rejected, (state, action) => {
        ...
        state.error =
          (action.payload as string) ||
          "Đã có lỗi xảy ra khi xóa sản phẩm khỏi giỏ hàng";
      })
    ...
    builder
      ...
      .addCase(clearCart.rejected, (state, action) => {
        state.isLoading = false;
        state.error =
          (action.payload as string) || "Đã có lỗi xảy ra khi xóa giỏ hàng";
      })
